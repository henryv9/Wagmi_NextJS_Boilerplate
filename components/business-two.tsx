...
import ethIcon from '../public/img/eth-icon.png'
import ethSmall from '../public/img/eth-sm.png'
                    ...
                    <Disclosure>
                        <Disclosure.Button className="bg-gray-700 items-center w-full  rounded-t-2xl flex flex-row">
                           ...
                           <div className="basis-3/6 justify-end grid auto-cols-max grid-cols-4">
                              <img className="w-5 h-5" src="/img/spiral-icon.png"  alt="" />
                              <img className="w-5 h-5" src="/img/leaf-icon.png"  alt="" />
                              <img className="w-5 h-5" src="/img/jewel-icon.png"  alt="" />
                            </div> 
                        </Disclosure.Button>
                    ...
                    <Disclosure>
                        <Disclosure.Button className="bg-gray-700 items-center w-full  rounded-t-2xl flex flex-row">
                           ...
                           <div className="basis-3/6 justify-end grid auto-cols-max grid-cols-4">
                              ...
                              <img className="w-5 h-5" src="/img/leaf-icon.png"  alt="" />
                              <img className="w-5 h-5" src="/img/jewel-icon.png"  alt="" />
                              <img className="w-5 h-5" src="/img/boat-icon.png"  alt="" />
                            </div> 
                        </Disclosure.Button>
                        <Disclosure.Panel className=" text-white bg-gray-700 px-5 py-5">
                            <div className="text-left">
